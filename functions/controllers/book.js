    ...
    async (req, res) => {
        ...
        try {
            await db.runTransaction(async (t) => {
                ...
                const { stockCountA, stockCountB, stockCountC, reservationCountA, reservationCountB, reservationCountC } = doc.data()
                switch (state) {
                    case "A":
                    case "a":
                        isPossible = stockCountA > reservationCountA;
                        break;
                    case "B":
                    case "b":
                        isPossible = stockCountB > reservationCountB;
                        break;
                    case "C":
                    case "c":
                        isPossible = stockCountC > reservationCountC;
                        break;
                }
...
bookApp.delete("/:bookId/reservations/:id", async (req, res) => {
    ...
    try {
        await db.runTransaction(async (t) => {
            ...
            const { isCancel, isSold, state } = doc.data();
